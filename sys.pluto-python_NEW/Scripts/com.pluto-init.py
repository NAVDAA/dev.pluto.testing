...
def ___SysPlutoINIT___(IsCapitalized=True):
    LogInMsg = __ConsoleWrtiteline__(f" %s (Codename: %s); Version [%s]." % (__SysPlutoControl__.PlutoSysNameSM, __SysPlutoControl__.PlutoCodename, __SysPlutoControl__.PlutoVer), f"\n Pip executeable: [%s]" % __SysPlutoControl__.PlutoPipPath, f"\n Python executeable: [%s]" % __SysPlutoControl__.PlutoPythonPath, f"\n %s" % __SysPlutoControl__.PlutoCopyright % (_SysGetDateTime_().year, __SysPlutoControl__.PlutoAuthorBG))
